...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    destaque: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
...
export interface ApiHomeSolucaoHomeSolucao extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '';
    displayName: 'Home Solu\u00E7\u00F5es';
    pluralName: 'home-solucoes';
    singularName: 'home-solucao';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text & Schema.Attribute.Required;
    image_source: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-solucao.home-solucao'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiHomeSomosBenedoHomeSomosBenedo
  extends Struct.CollectionTypeSchema {
  collectionName: 'home_somos_benedos';
  info: {
    displayName: 'Home Somos Benedo';
    pluralName: 'home-somos-benedos';
    singularName: 'home-somos-benedo';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-somos-benedo.home-somos-benedo'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    empreedimentos: Schema.Attribute.Relation<
      'oneToMany',
      'api::empreedimento.empreedimento'
    >;
    imprensas: Schema.Attribute.Relation<'oneToMany', 'api::imprensa.imprensa'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::home.home'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    solucoes: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-solucao.home-solucao'
    >;
    somos_benedos_cards: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-somos-benedo.home-somos-benedo'
    >;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiImprensaImprensa extends Struct.CollectionTypeSchema {
